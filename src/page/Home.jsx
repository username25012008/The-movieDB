          ...
          <header className="header_section h-[300px] flex justify-center items-center">
            <div className="container px-7 text-white flex flex-col gap-10">
              ...
              <div className="relative flex items-center">
                <input
                  type="text"
                  className=" bg-white w-full py-[10px] px-5 rounded-full placeholder:text-[#596169] text-[#596169] outline-none text-lg"
                  placeholder="Найти фильм, сериал, персону......"
                />
                <button className="bg-gr-b-gradient absolute right-0 rounded-full py-3 px-7 hover:text-black duration-300 ease-in-out">
                  Поиск
                </button>
              </div>
            </div>
          ...
          <div className="h-[472px]">
                ...
                <div className="border border-darkblue rounded-full inline-block">
                  <div className="flex">
                    <button
                      ...
                      className={`${
                        activeButton == false ? "bg-darkblue" : ""
                      } px-5 py-1 rounded-full`}
                    >
                      <p
                        className={`${
                          activeButton == false
                            ? "bg-gr-gradient bg-clip-text text-transparent"
                            : "text-darkblue"
                        } font-bold`}
                      >
                        Сегодня
                    ...
                    <div
                      className={`${
                        activeButton == "today" ? "bg-darkblue" : ""
                      } h-[33px]`}
                    ></div>
                  </div>
                </div>
            ...
            <div className="container relative pt-5 after">
              ...
              <img
                src={bg_section}
                alt="bg"
                className="absolute bottom-0 z-0 w-full bg-cover bg-center h-auto"
              />
            </div>
          </div>
              ...
              <div className="flex gap-5 items-center">
                ...
                <div className="flex border border-[#1ED5A9] rounded-full">
                  <button
                    className={`${
                      !activeButtonTwo
                        ? "bg-wh-gr-gradient text-darkblue"
                        : "text-white"
                    } rounded-full  text-base py-1 px-5 font-semibold`}
                    onClick={() => {
            ...
            <div className="px-10 flex gap-5">
              ...
              <div
                className={`rounded-full border border-darkblue ${
                  activeButtonThree ? "bg-darkblue" : "text-darkblue"
                }`}
              >
                <button
                  onClick={() => {
                    if (activeButtonThree == false) {
                      setActiveButtonThree(true);
                    } else {
                      setActiveButtonThree(false);
                    }
                  }}
                  className={`py-1 px-5  text-base font-semibold ${
                    activeButtonThree
                      ? "bg-gr-gradient bg-clip-text text-transparent"
                      : "text-darkblue"
                  }`}
            ...
            <div className="pt-5 ">
              <div className="users flex flex-wrap flex-row">
                <div className="user w-6/12 flex justify-between items-center gap-3">
                  <img
                    src="https://media.themoviedb.org/t/p/w64_and_h64_face/5BvxGhRE7yjtbHCXgrTxPk9hBXp.jpg"
                    alt="avatar"
                    className="w-14 h-14 rounded-full"
                  />
                  <div className="flex flex-col w-full">
                    <h1 className="text-xl text-black font-semibold hover:text-[#1ED5A9] duration-300 ease-in-out">
                      Shei
                    </h1>
